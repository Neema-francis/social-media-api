...
from social_media_api.utilities import querySet_to_list
from social_media_api.customMessages import CustomMessage
from social_media_api.models import StoryCards, userResponse, userTagWeitage
from social_media_api.serializers import StoryCardsSerialzer, StoryCardsListSerialzer, StoryCardResponseSerialzer
...
class StoryCardCreateAPIView(generics.CreateAPIView):
    """
    ...
    serializer_class = StoryCardsSerialzer
...
class StoryCardAPIView(generics.ListAPIView):
    """
    ...
    msg_ob = CustomMessage()
    permission_classes = (IsAuthenticated, IsSuperUser,)
    serializer_class = StoryCardsListSerialzer
...
class StoryCardStatusCountAPIView(generics.GenericAPIView):
    """
...
class StoryCardListAPIView(generics.ListAPIView):
    """
...
class StoryCardResponseAPIView(generics.CreateAPIView):
    """
